...
import com.haoyongsys.erp.common.pojo.pay.WxPayV3Bean;

import cn.aaron911.pay.core.enums.RequestMethod;
import cn.aaron911.pay.core.kit.AesUtil;
import cn.aaron911.pay.core.kit.PayKit;
import cn.aaron911.pay.core.kit.WxPayKit;
import cn.aaron911.pay.wxpay.WxPayApi;
import cn.aaron911.pay.wxpay.enums.WxApiType;
import cn.aaron911.pay.wxpay.enums.WxDomain;
...
public class WxPayV3Controller {
    ...
    public String index() {
        ...
        return ("欢迎使用 IJPay 中的微信支付 Api-v3 -By Javen  <br/><br> ");
    }
