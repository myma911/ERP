package com.haoyongsys.erp.common.base.jsms.api.sms;
...
import com.haoyongsys.erp.common.base.jsms.api.BaseTest;
import com.haoyongsys.erp.common.base.jsms.api.SlowTests;
...
public class SMSClientTest extends BaseTest {
    ...
    /**
     * 已通过测试
     * @Title: testSendSMSCode
     * @author Aaron
     */
    @Test
    public void testSendSMSCode() {
        SMSPayload payload = SMSPayload.newBuilder()
                .setMobileNumber("18232191096")
                //.setSignId(9490)
                .setTempId(153865)
                .build();

        JsonObject json = new JsonObject();
        json.addProperty("mobile", "18232191096");
        //json.addProperty("sign_id", 9490);
        json.addProperty("temp_id", 153865);
